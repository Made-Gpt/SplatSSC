...
class DeformableAggregationFunction(Function):
    ...
    def forward(
        ...
        mc_ms_feat = mc_ms_feat.contiguous().float()  # [1, 1, 102000, 96]
        spatial_shape = spatial_shape.contiguous().int()  # [[240, 320], [120, 160], [ 60,  80], [ 30,  40]]
        scale_start_index = scale_start_index.contiguous().int()  # [     0,  76800,  96000, 100800]
