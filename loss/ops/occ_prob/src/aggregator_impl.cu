...
OccAggregator::GeometryState OccAggregator::GeometryState::fromChunk(char*& chunk, size_t P)
{
	GeometryState geom;
...
OccAggregator::ImageState OccAggregator::ImageState::fromChunk(char*& chunk, size_t N)
{
	ImageState img;
...
OccAggregator::BinningState OccAggregator::BinningState::fromChunk(char*& chunk, size_t P)
{
...
// of Gaussians.
int OccAggregator::Aggregator::forward(
...
void OccAggregator::Aggregator::backward(
